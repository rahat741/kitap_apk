...
<head>
    ...
    <link rel="stylesheet" href="/backend/css/matrix-media.css" />blade.php <link href="/backend/font-awesome/css/font-awesome.css" rel="stylesheet" />
    <link rel="stylesheet" href="/backend/css/jquery.gritter.css" />
...
<div id="sidebar"><a href="#" class="visible-phone"><i class="icon icon-home"></i> Dashboard</a>
    <ul>
        <li class="active"><a href="index.blade.php"><i class="icon icon-home"></i> <span>Dashboard</span></a> </li>
...
<div id="content">
    ...
    <div id="content-header">
        <div id="breadcrumb"> <a href="index.blade.php" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a></div>
    </div>
    <!--End-breadcrumbs-->
    ...
    <div class="container-fluid">
        <div class="quick-actions_homepage">
            <ul class="quick-actions">
                <li class="bg_lb"> <a href="index.blade.php"> <i class="icon-dashboard"></i> <span class="label label-important">20</span> My Dashboard </a> </li>
                <li class="bg_lg span3"> <a href="charts.blade.php"> <i class="icon-signal"></i> Charts</a> </li>
                <li class="bg_ly"> <a href="widgets.blade.php"> <i class="icon-inbox"></i><span class="label label-success">101</span> Widgets </a> </li>
                <li class="bg_lo"> <a href="tables.blade.php"> <i class="icon-th"></i> Tables</a> </li>
                <li class="bg_ls"> <a href="grid.blade.php"> <i class="icon-fullscreen"></i> Full width</a> </li>
                <li class="bg_lo span3"> <a href="form-common.blade.php"> <i class="icon-th-list"></i> Forms</a> </li>
                <li class="bg_ls"> <a href="buttons.blade.php"> <i class="icon-tint"></i> Buttons</a> </li>
                <li class="bg_lb"> <a href="interface.blade.php"> <i class="icon-pencil"></i>Elements</a> </li>
                <li class="bg_lg"> <a href="calendar.blade.php"> <i class="icon-calendar"></i> Calendar</a> </li>
                <li class="bg_lr"> <a href="error404.blade.php"> <i class="icon-info-sign"></i> Error</a> </li>
            ...
            <div class="span6">
                        ...
                        <div class="chat-users panel-right2">
                            ...
                            <div class="panel-content nopadding">
                                <ul class="contact-list">
                                    <li id="user-Alex" class="online"><a href=""><img alt="" src="/backend/img/demo/av1.jpg" /> <span>Alex</span></a></li>
                                    <li id="user-Linda"><a href=""><img alt="" src="/backend/img/demo/av2.jpg" /> <span>Linda</span></a></li>
                                    <li id="user-John" class="online new"><a href=""><img alt="" src="/backend/img/demo/av3.jpg" /> <span>John</span></a><span class="msg-count badge badge-info">3</span></li>
                                    <li id="user-Mark" class="online"><a href=""><img alt="" src="img/demo/av4.jpg" /> <span>Mark</span></a></li>
                                    <li id="user-Maxi" class="online"><a href=""><img alt="" src="/backend/img/demo/av5.jpg" /> <span>Maxi</span></a></li>
                                </ul>
                            </div>
                        </div>
                ...
                <div class="widget-box">
                    ...
                    <div class="widget-content nopadding fix_hgt">
                        <ul class="recent-posts">
                            <li>
                                <div class="user-thumb"> <img width="40" height="40" alt="User" src="/backend/img/demo/av1.jpg"> </div>
                                <div class="article-post"> <span class="user-info">John Deo</span>
                                    <p>Web Desginer &amp; creative Front end developer</p>
                                </div>
                            </li>
                            <li>
                                <div class="user-thumb"> <img width="40" height="40" alt="User" src="/backend/img/demo/av2.jpg"> </div>
                                <div class="article-post"> <span class="user-info">John Deo</span>
                                    <p>Web Desginer &amp; creative Front end developer</p>
                                </div>
                            </li>
                            <li>
                                <div class="user-thumb"> <img width="40" height="40" alt="User" src="/backend/img/demo/av4.jpg"> </div>
                                <div class="article-post"> <span class="user-info">John Deo</span>
                                    <p>Web Desginer &amp; creative Front end developer</p>
                                </div>
                        </ul>
                ...
                <div class="widget-box">
                    ...
                    <div class="widget-content tab-content">
                        <div id="tab1" class="tab-pane active">
                            ...
                            <img src="/backend/img/demo/demo-image1.jpg" alt="demo-image"/></div>
                        <div id="tab2" class="tab-pane"> <img src="/backend/img/demo/demo-image2.jpg" alt="demo-image"/>
                            <p>And is full of waffle to It has multiple paragraphs and is full of waffle to pad out the comment. Usually, you just wish these sorts of comments would come to an end.multiple paragraphs and is full of waffle to pad out the comment.</p>
                        </div>
                        <div id="tab3" class="tab-pane">
                            <p>And is full of waffle to It has multiple paragraphs and is full of waffle to pad out the comment. Usually, you just wish these sorts of comments would come to an end.multiple paragraphs and is full of waffle to pad out the comment. </p>
                            <img src="/backend/img/demo/demo-image3.jpg" alt="demo-image"/></div>
                    </div>
                </div>
            </div>
        </div>
...
<script src="/backend/js/matrix.dashboard.js"></script>
<script src="/backend/js/jquery.gritter.min.js"></script>
<script src="/backend/js/matrix.interface.js"></script>
<script src="/backend/js/matrix.chat.js"></script>
<script src="/backend/js/jquery.validate.js"></script>
<script src="/backend/js/matrix.form_validation.js"></script>
<script src="/backend/js/jquery.wizard.js"></script>
<script src="/backend/js/jquery.uniform.js"></script>
<script src="/backend/js/select2.min.js"></script>
<script src="/backend/js/matrix.popover.js"></script>
